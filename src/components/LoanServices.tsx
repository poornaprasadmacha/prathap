            ...
            <div className="md:col-span-8 lg:col-span-9 bg-[#fffdfa] border border-[#eae4d9] rounded-2xl p-6 sm:p-8 space-y-6 relative border-r-4 border-r-sky-500">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                    <div className="bg-white p-4 rounded-xl border border-slate-200 text-center space-y-1">
                      <div className="w-7 h-7 rounded-full bg-sky-100 text-sky-700 font-bold flex items-center justify-center mx-auto">1</div>
                      <div className="font-bold text-slate-900">Consultation</div>
                      <p className="text-slate-600">Share your requirement & document check with M Prathap.</p>
                    </div>
                    <div className="bg-white p-4 rounded-xl border border-slate-200 text-center space-y-1">
                      <div className="w-7 h-7 rounded-full bg-sky-100 text-sky-700 font-bold flex items-center justify-center mx-auto">2</div>
                      <div className="font-bold text-slate-900">Bank Comparison</div>
                      <p className="text-slate-600">We compare rates across HDFC, SBI, ICICI & select best fit.</p>
                    </div>
                    <div className="bg-white p-4 rounded-xl border border-slate-200 text-center space-y-1">
                      <div className="w-7 h-7 rounded-full bg-sky-100 text-sky-700 font-bold flex items-center justify-center mx-auto">3</div>
                      <div className="font-bold text-slate-900">Sanction & Payout</div>
                      <p className="text-slate-600">Doorstep document pick-up, sanction letter & fast disbursement.</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="pt-4 flex flex-wrap items-center gap-3 border-t border-slate-200">
                ...
                <a
                  ...
                  className="bg-slate-900 hover:bg-slate-950 text-white font-bold px-4 py-2.5 rounded-xl text-xs flex items-center gap-2 transition-colors shadow-sm"
                >
