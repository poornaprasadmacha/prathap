...
import { ChevronDown, FileText, CheckCircle2, ExternalLink, Bell, ArrowRight, MessageCircle, Phone, Calculator } from "lucide-react";
...
export default function LatestUpdatesSection() {
  return (
    <section className="py-10 bg-white relative">
      ...
      {/* Downward Double Chevron Scroll Indicator */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* Section Heading: Two-Tone Typography */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#fffdfa] border border-[#e5dfd3] rounded-2xl overflow-hidden flex flex-col justify-between shadow-sm hover:border-emerald-500 transition-colors">
            ...
            <div className="px-5 pb-5 pt-2">
              ...
              >
                <span>ONLINE USER MANUAL & GUIDES</span>
          ...
          <div className="bg-[#fffdfa] border border-[#e5dfd3] rounded-2xl overflow-hidden flex flex-col justify-between shadow-sm hover:border-emerald-500 transition-colors">
            ...
            <div className="px-5 pb-5 pt-2">
              ...
              >
                ...
                <span>CALCULATE EMI & CHECK ELIGIBILITY</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-300 rounded-2xl overflow-hidden flex flex-col justify-between shadow-sm">
            ...
            <div className="px-4 pb-4 pt-1">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-2.5 px-3 rounded-xl text-xs flex items-center justify-center gap-2 transition-colors"
              >
